...
<node TEXT="虚拟化" FOLDED="false" ID="ID_1011942892" CREATED="1605620840890" MODIFIED="1608378943564" STYLE="wide_hexagon" UNIFORM_SHAPE="true">
...
<node TEXT="KVM" POSITION="right" ID="ID_1252698798" CREATED="1605620914373" MODIFIED="1608378962109">
<edge COLOR="#00ff00"/>
<node TEXT="特点" ID="ID_899536551" CREATED="1608378954654" MODIFIED="1608378957352">
<node TEXT="virtualization资源管理&#xa;x个无理资源--&gt;y个逻辑资源&#xa;实现程度&#xa;完全、部分、硬件辅助（现在的虚拟化软件都是硬件辅助虚拟化）" ID="ID_1569248020" CREATED="1608378957390" MODIFIED="1608378960336"/>
</node>
...
<node TEXT="virt-manager" ID="ID_1308362839" CREATED="1605621434115" MODIFIED="1608378972352">
<node TEXT="基本的图形管理工具,实现虚拟机软件般的管理功能,比如创建虚拟机,调节虚拟机配置,以图形界面运行虚拟机,生成快照等类似vmware,只是提供kvm部分功能而非全部" ID="ID_644018529" CREATED="1608378968135" MODIFIED="1608378970397"/>
</node>
<node TEXT="virsh" ID="ID_1874929901" CREATED="1605621638218" MODIFIED="1608378988863">
<node TEXT="特点" ID="ID_909524587" CREATED="1608378978158" MODIFIED="1608378982888">
<node TEXT="以命令管理虚拟机,提供各虚拟机的命令接口,支持交互模式,查看/创建/停止/关闭等功能&#xa;格式:virsh 控制指令 虚拟机名称 参数" ID="ID_470462968" CREATED="1608378982915" MODIFIED="1608378984027"/>
</node>
...
<node TEXT="取消虚拟机定义域&#xa;virsh undefine 虚拟机名称" ID="ID_379140980" CREATED="1605623155148" MODIFIED="1608379001388">
<node TEXT="从列表中删除指定虚拟机&#xa;要彻底删除虚拟机,只需把磁盘镜像文件和配置文件删除" ID="ID_745928115" CREATED="1608378996499" MODIFIED="1608378999059"/>
</node>
</node>
</node>
...
<node TEXT="写时复制/COW技术" POSITION="right" ID="ID_16072832" CREATED="1605621050106" MODIFIED="1608379019664">
<edge COLOR="#ff00ff"/>
<node TEXT="特点" ID="ID_998660200" CREATED="1608379011966" MODIFIED="1608379015056">
<node TEXT="特点:&#xa;直接影射原始盘（后端盘）数据内容&#xa;原始盘（后端盘）内容不变,并且不能修改原始盘内容,否则所有前端盘无法使用&#xa;对前端盘的修改不回写到原始盘（后端盘）&#xa;前端盘至少与后端盘一样大小,可以前端盘比后端盘大,不可以前端盘比后端盘小&#xa;优势:&#xa;一个后端盘可以影射出无数前端盘,前端盘在未写入新数据时不占用任何空间（因此只需在设置参数上大于或等于后端盘就行）,前端盘不管怎么修改不会影响到后端盘,一个后端盘就能影射出无数虚拟机,大大节省克隆虚拟机的时间和占用空间,新虚拟机占用磁盘仅数百KB" ID="ID_1141965159" CREATED="1608379015072" MODIFIED="1608379017971"/>
</node>
...
<edge COLOR="#00ffff"/>
<node TEXT="安装libguestfs-tools-c包" ID="ID_1605267214" CREATED="1605624740712" MODIFIED="1608379029746">
<node TEXT="支持离线挂载raw,qcow2格式虚拟磁盘&#xa;可以在虚拟机关机的情况下直接修改磁盘中的文档&#xa;方便对虚拟机定制、修复、脚本维护&#xa;但需要注意SELinux机制的影响,需先把SELinux设为宽松模式,或禁用模式" ID="ID_1002338946" CREATED="1608379025305" MODIFIED="1608379028014"/>
</node>
<node TEXT="guestmount -a 虚拟磁盘镜像文件 -i 挂载点" ID="ID_420799623" CREATED="1605624952544" MODIFIED="1608379037491">
<node TEXT="挂载磁盘镜像文件的命令,挂载后直接访问挂载点就可以对镜像做修改定制了" ID="ID_817335003" CREATED="1608379033025" MODIFIED="1608379035817"/>
</node>
</node>
<node TEXT="VDO/虚拟数据优化器" POSITION="right" ID="ID_1588467687" CREATED="1605626127616" MODIFIED="1608379060739">
<edge COLOR="#7c0000"/>
<node TEXT="特点" ID="ID_761682758" CREATED="1608379055551" MODIFIED="1608379057546">
<node TEXT="virtual data optimizer&#xa;一个内核模块,目的是通过重删减少磁盘的空间占用,以及减少复制带宽&#xa;VDO是基于块设备层之上的,也就是在原设备之上影射出mapper虚拟设备,然后直接使用即可,表现为1G容量装1.5G数据&#xa;特点:&#xa;重复数据删除,输入的数据先判断是否为冗余数据,判断为重复的部分不会写入,然后对源数据进行更新,直接指向原始已经存储的数据块即可&#xa;压缩,对每个单独的数据块进行处理" ID="ID_256684402" CREATED="1608379049510" MODIFIED="1608379053179"/>
</node>
...
<node TEXT="制作VDO卷" ID="ID_963885350" CREATED="1605626658776" MODIFIED="1608379074522">
<node TEXT="特点" ID="ID_247672488" CREATED="1608379067487" MODIFIED="1608379070553">
<node TEXT="参考man vdo全文查找/example&#xa;制作VDO需要2G以上的内存" ID="ID_539261630" CREATED="1608379070577" MODIFIED="1608379072822"/>
</node>
