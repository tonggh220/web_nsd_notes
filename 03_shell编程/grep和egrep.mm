...
<node TEXT="grep和egrep文本過濾" FOLDED="false" ID="ID_181615285" CREATED="1607426509546" MODIFIED="1607427203585" STYLE="oval">
<font SIZE="18"/>
<hook NAME="MapStyle">
...
<node TEXT="用法" POSITION="right" ID="ID_348005660" CREATED="1607426528896" MODIFIED="1607426593410">
<edge COLOR="#ff0000"/>
<node TEXT="egrep [選項]  &apos;正則表達式&apos; 文件.." ID="ID_142941103" CREATED="1607426593426" MODIFIED="1607426642199"/>
<node TEXT="前置命令 | egrep  [選項]  &apos;正則表達式&apos;" ID="ID_1752087407" CREATED="1607426644754" MODIFIED="1607426678079"/>
</node>
<node TEXT="選項" POSITION="right" ID="ID_1077416311" CREATED="1607426684647" MODIFIED="1607426691827">
<edge COLOR="#0000ff"/>
<node TEXT="-i  忽略字母大小寫" ID="ID_1130099943" CREATED="1607426691843" MODIFIED="1607426705475"/>
<node TEXT="-v  條件取反" ID="ID_730517992" CREATED="1607426705660" MODIFIED="1607426712461"/>
<node TEXT="-c  統計匹配的行數" ID="ID_349932785" CREATED="1607426712692" MODIFIED="1607426721815"/>
<node TEXT="-q  靜默、無任何輸出,一般配合$?反回值監測執行結果" ID="ID_63538769" CREATED="1607426721976" MODIFIED="1607426844421"/>
<node TEXT="-n  顯示出匹配結果所在的行號" ID="ID_1789449536" CREATED="1607426741055" MODIFIED="1607426751533"/>
<node TEXT="--color  高量顯示匹配字串" ID="ID_201924629" CREATED="1607426751867" MODIFIED="1607426774366"/>
</node>
</node>
</map>
